...
def main():
    ...
    f = open(f'{args.output_dir}/results_testlet{args.testlet_nr}_template{args.use_template}_{args.models}_{timestamp}.csv', 'w')
    log = open(f'{args.output_dir}/log/log_testlet{args.testlet_nr}_template{args.use_template}_{args.models}_{timestamp}.csv', 'w')
    writer = csv.writer(f)
